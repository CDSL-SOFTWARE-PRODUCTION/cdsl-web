...
export const metadata: Metadata = {
    ...
    description: "Explore CDSL's range of services from Product Strategy to Engineering and Recruitment.",
};
...
export default function ServicesPage() {
    return (
        <main className="bg-premium-navy transition-colors duration-300">
                    ...
                    <div className="max-w-4xl">
                        ...
                        <h1 className="font-display font-bold text-6xl md:text-8xl leading-[0.9] tracking-tighter text-white mb-12">
                            <div className="flex flex-col gap-2">
                                ...
                                <span className="text-premium-gray">connect with customers</span>
                                <span>by creating <span className="text-premium-blue">products</span></span>
                            </div>
                        </h1>
            ...
            <section className="py-32 px-4 site-container relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={industry.title} className="p-8 rounded-[5px] bg-premium-navy-light border border-white/5 hover:border-premium-blue/50 transition-all duration-300 group">
            ...
            {/* Let's Collaborate */}
            <section className="py-32 px-4 site-container text-center relative z-10">
                <div className="flex justify-center mb-8">
                    <div className="p-6 bg-premium-blue/10 rounded-full text-premium-blue animate-pulse">
                        <Handshake size={64} strokeWidth={1} />
                    </div>
                </div>
                <h2 className="text-5xl md:text-7xl font-display font-bold text-white mb-8 tracking-tighter">
                    Let's collaborate!<br />What's the next step?
                </h2>
                <div className="flex flex-wrap justify-center gap-6">
                    <Link href="/contact" className="px-12 py-5 bg-premium-blue text-premium-navy font-display font-bold text-lg hover:scale-105 transition-transform rounded-[1px]">
                        GET IN TOUCH
                    </Link>
                </div>
            </section>
            ...
            {/* Final CTA */}
            <section className="py-24 px-4 site-container relative z-10">
                <div className="px-8 py-24 rounded-[5px] bg-premium-navy-light border border-white/5 text-center relative overflow-hidden group">
                    <div className="absolute inset-0 bg-premium-blue/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>

                    <h2 className="text-5xl md:text-8xl font-display font-bold text-white mb-6 uppercase tracking-tighter relative z-10">
                        LET'S TALK ABOUT<br />YOUR PRODUCT!
                    </h2>
                    <p className="text-2xl text-premium-gray font-light mb-12 relative z-10">
                        Ready to turn your vision into a market-leading product?
                    </p>
                    <button className="group px-12 py-6 bg-white text-premium-navy font-display font-black text-xl hover:bg-premium-blue transition-colors flex items-center gap-4 mx-auto relative z-10 rounded-[1px]">
                        LET'S WORK TOGETHER <Plus size={24} />
                    </button>
                </div>
            </section>
            ...
            {/* Newsletter */}
            <section className="py-32 px-4 site-container relative z-10">
                <div className="max-w-4xl mx-auto border-t border-white/10 pt-24 text-center">
                    <h3 className="text-2xl font-display font-medium text-white mb-12">Sign up for the newsletter</h3>
                    <form className="flex flex-col md:flex-row gap-4">
                        <input
                            type="email"
                            placeholder="name@email.com"
                            className="flex-grow bg-premium-navy-light border border-white/10 rounded-[2px] px-8 py-5 text-white placeholder:text-white/20 focus:outline-none focus:border-premium-blue transition-colors"
                        />
                        <button className="px-10 py-5 bg-premium-blue text-premium-navy font-bold rounded-[2px] flex items-center justify-center gap-3 group hover:bg-premium-blue/90 transition-colors">
                            SUBSCRIBE <ArrowRight className="group-hover:translate-x-2 transition-transform" />
                        </button>
                    </form>
                </div>
            </section>
